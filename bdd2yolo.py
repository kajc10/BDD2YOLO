...
if __name__ == "__main__":
    ...
    parser.add_argument('--bdd_file', help='path of the bbd json file', required=True)
    parser.add_argument('--yolo_dir', help='directory where yolo labels should be generated', required=True)
